      ...
      {isLoading ? (
        ...
        <div className="grid gap-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
            ...
            <Card className="rounded-[2rem] border-none shadow-sm bg-accent text-accent-foreground p-8">
              <p className="text-xs uppercase font-bold opacity-70 mb-2 tracking-widest">Выручка</p>
              <h2 className="text-4xl font-black">
                {sales.reduce((acc, s) => acc + (s.price || 0), 0)} ₽
              </h2>
            </Card>
          </div>
