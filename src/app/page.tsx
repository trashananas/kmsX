    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="container px-4 text-center z-10 py-20">
          <div className="relative w-48 h-48 md:w-64 md:h-64 mx-auto mb-12 shadow-2xl rounded-[3rem] md:rounded-[4rem] overflow-hidden border-4 md:border-8 border-white bg-white">
            <Image 
              src={logoUrl} 
              alt="Клуб логотип" 
              fill 
